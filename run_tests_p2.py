"""
Test Runner for convert_numbers.py
...
TEST_CASES = [
    "test_files/P2_TC1.txt",
    "test_files/P2_TC2.txt",
    "test_files/P2_TC3.txt",
    "test_files/P2_TC4.txt",
]

def run_test(test_file):
    """Run a single test case and return the output."""
    result = subprocess.run(
        [sys.executable, "convert_numbers.py", test_file],
        capture_output=True,
        text=True
    )
...
def main():
    ...
    output_lines.append("EVIDENCIA DE EJECUCION - convert_numbers.py")
    ...
    # Save to file
    with open("P2_TestEvidence.txt", "w", encoding="utf-8") as f:
        f.write(full_output)

    print(f"\nEvidencia guardada en: P2_TestEvidence.txt")
