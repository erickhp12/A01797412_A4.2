"""
Test Runner for compute_statistics.py
...
def run_test(test_file):
    ...
    result = subprocess.run(
        [sys.executable, "compute_statistics.py", test_file],
        capture_output=True,
        text=True
    )
...
def main():
    ...
    output_lines.append("EVIDENCIA DE EJECUCION - compute_statistics.py")
    ...
    # Save to file
    with open("P1_TestEvidence.txt", "w", encoding="utf-8") as f:
        f.write(full_output)

    print(f"\nEvidencia guardada en: P1_TestEvidence.txt")
